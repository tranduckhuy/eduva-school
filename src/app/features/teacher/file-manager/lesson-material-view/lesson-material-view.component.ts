...
@Component({
  selector: 'lesson-material-view',
  standalone: true,
  imports: [LessonTableComponent, MaterialTableComponent],
  templateUrl: './lesson-material-view.component.html',
  styleUrl: './lesson-material-view.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class LessonMaterialViewComponent {
  lessons: Lesson[] = [
    {
      id: Date.now() + 1,
  ...
  currentView = input<'lesson' | 'material'>();
  viewChanged = output<'lesson' | 'material'>();
}
